...
class AlphaQuartz_Dextro_zp(GeneralCrystal):

    description = "dextro alpha quartz (left-handed screw), z+ (reverse) setting, anisotropic thermal ellipsoids"
    ...
    def plot_fit_data(self):
        ...
        plt.savefig('AlphaQuartz_Dextro_zp_Lattice&AtomPos.png')
        plt.close(1)
        ...
        plt.savefig('AlphaQuartz_Dextro_zp_SiThermEll.png')
        plt.close(2)
        ...
        plt.savefig('AlphaQuartz_Dextro_zp_OThermEll.png')      
        plt.close(3)
