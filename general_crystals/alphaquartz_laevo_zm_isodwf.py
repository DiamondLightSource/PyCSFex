...
class AlphaQuartz_Laevo_zm_isodwf(GeneralCrystal):

    description = "laevo alpha quartz (right-handed screw), z- (reverse) setting, isotropic thermal atomic motion using Debye model"
    ...
    def plot_fit_data(self):
        ...
        plt.savefig('AlphaQuartz_Laevo_zm_isodwf_Lattice&AtomPos.png')
        plt.close(1)
